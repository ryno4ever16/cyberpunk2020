...
/**
 * QA §14 — Armor layering EV penalties (CP2020 errata p.99, "New Rule 1").
 *   2nd non-skinweave armor layer at a location: +1 EV
 *   3rd layer: +2 more (total +3 EV for 3 layers)
 *   EV reduces effective REF. Gated by `applyLayerEVPenalty`; `layerRuleSystem` = Core/CB4.
 *
 * Uses zero-encumbrance armor so only the LAYER EV moves REF (isolated from armor base EV).
 */
