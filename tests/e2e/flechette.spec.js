...
/**
 * Refinement — Flechette ammo (Blackhand's): a spread weapon whose armor multiplier is ×¼,
 * not ×½. The fix: the _getAmmoProps AP shortcut now fires only for EXACTLY 0.5 mults, so a
 * quarter (0.25) flows through the true multiplier path instead of collapsing to a half-SP AP.
 */
