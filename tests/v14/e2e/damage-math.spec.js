...
/**
 * Rig-portable port of tests/e2e/damage-math.spec.js (QA §2 — Damage math, CP2020 p.98-99).
 * Identical body; only the login swaps to the rig (loginRig). Creates its own actors/armor,
 * drives the real resolveAreaDamages export (dry-run), asserts SP / AP / hollow-point / armor
 * modes / BTM / head doubling / minimum-1.
 */
