...
import { loginRig, evalGameOrThrow, cleanupTestData, waitForCanvasScene } from "./rig-e2e-helpers.js";

/**
 * Rig-portable port of tests/e2e/limb-head.spec.js — identical body; login swapped to the rig (loginRig).
 *
