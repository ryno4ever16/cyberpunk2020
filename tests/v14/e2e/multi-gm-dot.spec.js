...
import { loginRig, loginRigAs, ensureRigUsers, evalGameOrThrow, setupSceneWithToken, cleanupTestData } from "./rig-e2e-helpers.js";

/**
 * Rig-portable port of tests/e2e/multi-gm-dot.spec.js — multi-account; logins swapped to loginRig/loginRigAs + ensureRigUsers.
 *
...
test.beforeAll(async ({ browser }) => {
  ...
  await loginRigAs(gm2Page, "Assistant Gamemaster"); // Assistant Gamemaster — also a GM
