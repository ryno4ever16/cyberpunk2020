...
import { properCase, localize, getDefaultSkills, cwHasType, cwIsEnabled, cwIsSkinweave, isAwarenessSkill } from "../utils.js"
...
export class CyberpunkActor extends Actor {
  ...
  async rollSkill(skillId, extraMod = 0, advantage = false, disadvantage = false, hiddenAdvantage = false) {
    ...
    const parts = [
      ...
      isAwarenessSkill(skill) ? "@CombatSenseMod" : null,
      extraMod || null
    ].filter(Boolean);
