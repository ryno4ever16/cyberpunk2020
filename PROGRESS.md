...
**Validation:** the full v14 Playwright suite is **18/18 on BOTH rigs** — v13.350 (`:30003`) and v14.364 (`:30002`) — plus **185/185 Vitest** unit tests. Specs live in `tests/v14/` and `tests/unit/`. **14 commits on `v14-compat`; nothing pushed.**
